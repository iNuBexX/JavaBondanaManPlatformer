...
public class oldMain {
   ...
   /* private HashMap<KeyCode, Boolean> keys = new HashMap<KeyCode, Boolean>();
    ...
    private LevelData CurrentLevel = new LevelData(1);
    private void initContent() {
        Rectangle bg = new Rectangle(1280, 720);

        levelWidth = CurrentLevel.LEVEL[0].length() * 60;

        for (int i = 0; i < CurrentLevel.LEVEL.length; i++) {
            String line = CurrentLevel.LEVEL[i];
